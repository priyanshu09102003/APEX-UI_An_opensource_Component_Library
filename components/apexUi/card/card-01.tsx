...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched Apex UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "Apex UI Documentation",
            description: "A comprehensive guide to Apex UI",
