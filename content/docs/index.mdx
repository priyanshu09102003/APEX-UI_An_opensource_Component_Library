---
title: Installation
description: Getting started with Apex-Ui
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://ui.apexui.dev/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.apexui.dev/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://apexui/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.apexui.dev/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.apexui.dev/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.apexui.dev/r/card-05.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.apexui.dev/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.apexui.dev/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.apexui.dev/r/ai-card-generation.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.apexui.dev/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.apexui.dev/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.apexui.dev/r/card-05.json -c ./apps/www
```
